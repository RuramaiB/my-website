...
$rainbow_sidenav_menu_args_one = Rainbow_Helper::rainbow_mobile_menu_args_one();
$menu_type = rainbow_get_acf_data( "inbio_menu_type");
if ($menu_type == "onepage"){
    $select_mobile_menu = $rainbow_sidenav_menu_args;
    $is_mobile = 'is-mobile-onepage';
} else {  
    $select_mobile_menu = $rainbow_sidenav_menu_args_one;
...
?>
<header class="rn-header header-style-1 haeder-default black-logo-version header-right-align <?php echo esc_attr($header_transparent); ?>
    <?php echo esc_attr($header_sticky); ?>">
                ...
                <div class="col-lg-10 col-6">
                    <div class="header-center"> 
                        ...
                        <div class="header-right">
                            ...
                            <?php if ( 'false' !== $header_button && "no" !== $header_button && "0" !== $header_button): ?>
...
<div class="popup-mobile-menu <?php echo esc_attr($is_mobile); ?>">
    <div class="inner">
        ...
        <div class="content">
            <?php if (has_nav_menu('primary')) {
                wp_nav_menu($select_mobile_menu);
            } ?>
