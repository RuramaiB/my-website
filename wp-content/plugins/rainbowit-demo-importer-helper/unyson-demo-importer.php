...
class Rainbow_Demo_Importer {
	...
	public function rainbowit_demo_config( $demos ) {
		$demos_array = array(
            ...
            'senior_uiux_designer' => array(
                'title' 			=> esc_html__( 'Senior UI/UX Designer', 'rainbowitdemo' ),
                'screenshot' 		=> RAINBOWIT_PREVIEW . 'sr-designer-dark.png',
                'preview_link' 		=> RAINBOWIT_PREVIEW_LINK . 'senior-ux-designer',
            ),
            'senior_uiux_designer_light' => array(
                'title' 			=> esc_html__( 'Senior UI/UX Designer Light', 'rainbowitdemo' ),
                'screenshot' 		=> RAINBOWIT_PREVIEW . 'sr-designer-light.png',
                'preview_link' 		=> RAINBOWIT_PREVIEW_LINK . 'senior-ux-designer-light',
            ),
            'doctor' => array(
                'title' 			=> esc_html__( 'Doctor', 'rainbowitdemo' ),
                'screenshot' 		=> RAINBOWIT_PREVIEW . 'doctor-dark.png',
                'preview_link' 		=> RAINBOWIT_PREVIEW_LINK . 'doctor',
            ),
            'doctor_light' => array(
                'title' 			=> esc_html__( 'Doctor Light', 'rainbowitdemo' ),
                'screenshot' 		=> RAINBOWIT_PREVIEW . 'doctor-light.png',
                'preview_link' 		=> RAINBOWIT_PREVIEW_LINK . 'doctor-light',
            ),
            'lawyer' => array(
                'title' 			=> esc_html__( 'Lawyer', 'rainbowitdemo' ),
                'screenshot' 		=> RAINBOWIT_PREVIEW . 'lawyer-dark.png',
                'preview_link' 		=> RAINBOWIT_PREVIEW_LINK . 'lawyer',
            ),
            'lawyer_light' => array(
                'title' 			=> esc_html__( 'Lawyer Light', 'rainbowitdemo' ),
                'screenshot' 		=> RAINBOWIT_PREVIEW . 'lawyer-light.png',
                'preview_link' 		=> RAINBOWIT_PREVIEW_LINK . 'lawyer-light',
            ),
            'designer_two' => array(
            ...
            'marketer' => array(
                'title' 			=> esc_html__( 'marketer', 'rainbowitdemo' ),
                'screenshot' 		=> RAINBOWIT_PREVIEW . 'marketer.png',
                'preview_link' 		=> RAINBOWIT_PREVIEW_LINK . 'marketer',
            ),
	...
	public function rainbowit_after_demo_install( $collection ){
		...
		$demos = array(
			...
			'demo2'  => 756,
			'demo2_light'  => 3976,
            'senior_uiux_designer'  => 5022,
            'senior_uiux_designer_light'  => 5150,
            'doctor'  => 5043,
            'doctor_light'  => 5111,
            'lawyer'  => 4932,
            'lawyer_light'  => 4989,
