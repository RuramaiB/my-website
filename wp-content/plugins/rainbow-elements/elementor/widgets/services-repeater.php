    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => array(
                    '{{WRAPPER}} .rn-service .inner .icon i, {{WRAPPER}} .service-card-one .inner i' => 'color: {{VALUE}} !important',
                    '{{WRAPPER}} .rn-service .inner .icon svg, {{WRAPPER}} .service-card-one .inner svg' => 'stroke: {{VALUE}} !important',
                ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => array(
                    '{{WRAPPER}} .rn-service:hover .inner .content .read-more-button:hover' => 'color: {{VALUE}} !important',
                ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => array(
                    '{{WRAPPER}} .rn-service .inner .content p.description, {{WRAPPER}} .service-card-one .inner p.describe' => 'color: {{VALUE}} !important',
                ),
            ]
        );
