...
class Portfolio_Grid extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
			'project_filter',
			[
				'label' => esc_html__( 'Filter Enable?', 'rainbow-elements' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('All Button Label', 'rainbow-elements'),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('All Project', 'rainbow-elements'),
                'placeholder' => esc_html__('Type all project button label here', 'rainbow-elements'),
                'condition' => [
                    'style' => '1',
                    'project_filter' => 'yes'
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Filter Style', 'rainbow-elements'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'style' => '1',
                    'project_filter' => 'yes'
        ...
        $this->add_control(
            'filter_cat_color',
            [
                'label' => __('Category Filter Color', 'rainbow-elements'),
                'type' => Controls_Manager::COLOR,
                'default' => '',

                'selectors' => array(
                    '{{WRAPPER}} .rn-portfolio-area .filter-button-default button' => 'color: {{VALUE}}',
                ),
            ]
        );

        $this->add_control(
            'filter_cat_hover_color',
            [
                'label' => __('Category Filter Hover Color', 'rainbow-elements'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => array(
                    '{{WRAPPER}} .rn-portfolio-area .filter-button-default button:hover,{{WRAPPER}} .rn-portfolio-area .filter-button-default .is-checked' => 'color: {{VALUE}}',
                ),
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rn-portfolio-area .filter-button-default button' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        ...
        $this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .rn-portfolio-area .filter-button-default button',
			]
		);

        $this->add_control(
			'category_hover_bg_color_heading',
			[
				'label' => esc_html__( 'Category Hover BG', 'rainbow-elements' ),
        ...
        $this->add_group_control(
			\Elementor\Group_Control_Background::get_type(),
			[
				'name' => 'category_bg_hovercolor',
				'types' => [ 'classic', 'gradient' ],
				'selector' => '{{WRAPPER}} .rn-portfolio-area .filter-button-default button:hover',
			]
		);
